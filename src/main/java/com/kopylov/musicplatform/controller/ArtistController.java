...
public class ArtistController {
    ...
    public ResponseEntity<SuccessMessageDTO> saveArtist(@ModelAttribute SaveUpdateArtistDTO dto) throws IOException {
    ...
    public ResponseEntity<SuccessMessageDTO> deleteArtist(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<SuccessMessageDTO> updateArtist(
    ...
    public ResponseEntity<ArtistListDTO> findArtistsByTitle(@PathVariable String name) {
